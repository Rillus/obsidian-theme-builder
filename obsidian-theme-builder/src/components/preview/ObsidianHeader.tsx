...
const ObsidianHeader: React.FC<ObsidianHeaderProps> = ({ collapsed, onToggleSidebar }) => {
  return (
    <header className="obsidian-header">
      <div className="header-left">
        ...
        <nav className="header-menu">
          ...
          <button className="menu-item">Plugins</button>
      ...
      <div className="header-right">
        {/* Quick actions */}
        <button className="header-action" title="Create new note">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
